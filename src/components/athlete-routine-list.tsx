...
const RoutineList = ({ routinesToShow, setSessionRoutine, setVideoUrl }: { routinesToShow: Routine[], setSessionRoutine: (routine: Routine) => void, setVideoUrl: (url: string) => void }) => {
    ...
    <>
      ...
      <Tabs defaultValue="week" className="w-full">
          ...
          <TabsContent value="week">
              <RoutineList routinesToShow={thisWeekRoutines} setSessionRoutine={setSessionRoutine} setVideoUrl={setVideoUrl} />
          </TabsContent>
          <TabsContent value="month">
              <RoutineList routinesToShow={thisMonthRoutines} setSessionRoutine={setSessionRoutine} setVideoUrl={setVideoUrl} />
          </TabsContent>
          <TabsContent value="older">
              <RoutineList routinesToShow={olderRoutines} setSessionRoutine={setSessionRoutine} setVideoUrl={setVideoUrl} />
          </TabsContent>
      </Tabs>
    </>
  );
