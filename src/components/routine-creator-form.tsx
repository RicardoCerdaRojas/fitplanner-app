...
function ExercisesForBlock({ control, blockIndex, setActiveSelection }: { control: Control<RoutineFormValues>, blockIndex: number, setActiveSelection: (selection: any) => void }) {
